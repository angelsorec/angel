...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/angelsorec/Files_angel/master/File_Bot/commands.lua") 
...
sudo_users = {SUDO,648027560,648027560}   
...
local ANGEL_Msg = ''  
if msgs < 100 then 
ANGEL_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
ANGEL_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
ANGEL_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
ANGEL_Msg = 'متفاعل' 
elseif msgs < 1200 then 
ANGEL_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
ANGEL_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
ANGEL_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
ANGEL_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
ANGEL_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
ANGEL_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
ANGEL_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
ANGEL_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
ANGEL_Msg = 'رب التفاعل'  
end 
return ANGEL_Msg 
end
...
--------------------------------------------------------------------------------------------------------------
function SourceANGEL(msg,data) -- بداية العمل
if msg then
...
send(msg.chat_id_, msg.id_,ANGEL_Msg) 
return false  
end 
if text then    
...
os.execute('wget https://raw.githubusercontent.com/angelsorec/ANGEL/main/ANGEL.lua')
send(msg.chat_id_, msg.id_,' ⌔┆ تم تحديث السورس \n ⌔┆ لديك اخر اصدار لسورس اينجل\n ⌔┆ الاصدار » { 1.3v}')
dofile('ANGEL.lua')  
end
if text == 'الاصدار ⌔' and SudoBot(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ⌔┆ اصدار سورس اينجل \n ⌔┆ الاصدار »{ 1.3v}')
end
if text == 'قناه تحديثات البوت ⌔' and SudoBot(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ⌔┆ [تحديثات البوت](t.me/nodals) \n ⌔┆ [قناه السورس](t.me/nodals)')
end
...
send(msg.chat_id_, msg.id_,'⌔┆  عدد الكروبات الان » { '..#group..' }'..ANGELk..''..ANGEL..'\n⌔┆  الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
usertext = '\n ⌔┆ العضو » ['..result.title_..'](t.me/'..(username or 'ANGEL')..')'
status  = '\n ⌔┆ تم ترقيته مطور'
...
local ANGEL1_Msg = database:get(bot_id.."ANGEL1:Add:Filter:Rp2"..text..msg.chat_id_)   
if ANGEL1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ⌔┆ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'ANGEL')..') \n ⌔┆ '..ANGEL1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if ANGEL_Msg and not Special(msg) then  
local ANGEL_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if ANGEL_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
send(msg.chat_id_,0, " ⌔┆ عذرا » {["..data.first_name_.."](T.ME/nodals)}\n ⌔┆ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
⧉️↬𝐸𝑁𝐺𝐿𝑆
 ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
⧉️↬[𝐶𝐻 𝐸𝑁𝐺𝐿𝑆](https://t.me/nodals)
⧉️↬[Tele](https://t.me/D6d6I)
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ⌔┆ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'ANGEL')..') \n ⌔┆ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ⌔┆ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'ANGEL')..') \n ⌔┆ تـم قفـل التاك بالكتم ')
end,nil)   
...
if database:get(bot_id.."D6d6I:admin:Time"..msg.chat_id_) then 
return
 send(msg.chat_id_, msg.id_,"انتظر دقيقه من فضلك")
end
database:setex(bot_id..'D6d6I:admin:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
...
if SudoBot(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/angelsorec/Files_ANGEL/master/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ⌔┆ اهلا بك في متجر ملفات اينجل\n ⌔┆ ملفات السورس ↓\n『─────·𖤐·─────』\n\n"
local TextE = "\n『─────·𖤐·─────』\n ⌔┆ علامة تعني { ✓ } ملف مفعل\n ⌔┆ علامة تعني { ✘ } ملف معطل\n ⌔┆ قناة سورس اينجل ↓\n".." ⌔┆ [اضغط هنا لدخول](t.me/nodals) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/angelsorec/Files_ANGEL/master/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('ANGEL.lua')  
else
send(msg.chat_id_, msg.id_," ⌔┆ عذرا الملف لايدعم سورس اينجل \n") 
end
return false
end
...
local UserName = (b.username_ or "ANGEL")
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ⌔┆ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'ANGEL')..')'
status  = '\n ⌔┆ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ⌔┆ العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ⌔┆ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'ANGEL')..')'
...
database:set(bot_id.."ANGEL1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."ANGEL1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," ⌔┆ ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."ANGEL1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."ANGEL1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."ANGEL1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."ANGEL1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," ⌔┆ تم منع الكلمه مع التحذير")  
database:del(bot_id.."ANGEL1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."ANGEL1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."ANGEL1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."ANGEL1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," ⌔┆ ارسل الكلمه الان")  
database:set(bot_id.."ANGEL1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."ANGEL1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."ANGEL1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."ANGEL1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."ANGEL1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."ANGEL1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."ANGEL1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."ANGEL1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."ANGEL1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n ⌔┆ قائمة المنع \n『─────·𖤐·─────』\n"
for k,v in pairs(list) do  
local ANGEL_Msg = database:get(bot_id.."ANGEL1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..ANGEL_Msg.."}\n"    
end  
if #list == 0 then  
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ⌔┆ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'ANGEL')..')'..'\n ⌔┆ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
database:sadd(bot_id.."D6d6I:MN:TF"..msg.chat_id_, msg.id_)
end
...
local num = database:smembers(bot_id.."D6d6I:MN:TF"..msg.chat_id_)
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'اينجل').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'اينجل')
local ANGEL_Msg = {
'عمغي 🥺💕.',
'هاا شتريد كافي ☹️.',
'مشايف بوت شني 😂.',
...
send(msg.chat_id_, msg.id_,'['..ANGEL_Msg[math.random(#ANGEL_Msg)]..']') 
return false
end
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'اينجل').." غادر" or text == 'غادر' then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'ANGEL')..')'
local iduser = result.sender_user_id_
...
-- vardump(data) 
ANGELdx(msg.chat_id_, msg.id_, ' ⌔┆ ايدي المجموعة » ( '..msg.chat_id_..' )\n ⌔┆ عدد الادمنيه » ( *'..data.administrator_count_..' )*\n ⌔┆ عدد المحظورين » ( *'..data.kicked_count_..' )*\n ⌔┆ عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'اينجل')
...
ANGEL = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(ANGEL)
...
--------------------------------------------------------------------------------------------------------------
SourceANGEL(data.message_,data)
...
------------------------------------------------------------------------
local ANGELAbot = database:get(bot_id.."ANGEL1:Add:Filter:Rp2"..text..result.chat_id_)   
if ANGELAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ⌔┆ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ⌔┆ ["..ANGELAbot.."] \n") 
else
send(msg.chat_id_,0," ⌔┆ العضو : {["..data.first_name_.."](T.ME/ANGEL)}\n ⌔┆ ["..ANGELAbot.."] \n") 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = data.message_id_}) 
return false
...
------------------------------------------------------------------------
if text then
local ANGEL1_Msg = database:get(bot_id.."ANGEL1:Add:Filter:Rp2"..text..result.chat_id_)   
if ANGEL1_Msg then    
send(msg.chat_id_, msg.id_," ⌔┆ "..ANGEL1_Msg)
